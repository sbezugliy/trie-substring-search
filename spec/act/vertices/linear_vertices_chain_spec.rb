RSpec.describe ACT::Vertex do
  ...
  describe "Linear vertices in trie" do
    ...
    it "nesting root -> c_vert is correct" do
      expect(root.childs).to include(c_vert)
    ...
    it "nesting b_vert -> a_vert is correct" do
      expect(b_vert.childs).to include(a_vert)
    ...
    it "only last vertice of trie should contain end_index of word in dictionary" do
