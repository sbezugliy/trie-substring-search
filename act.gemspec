...
Gem::Specification.new do |spec|
  ...
  spec.summary       = %q{"Ruby library realising Aho-Corasick substring search algorithm"}
  spec.description   = %q{This gem provides ruby library with realisation of Aho-Corasick substring search algorithm, with linear complication.}
